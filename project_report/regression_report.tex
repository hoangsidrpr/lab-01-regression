...
\begin{document}
	...
	\begin{itemize}
		...
		Hình bên dưới mô tả quá trình duyệt để chọn alpha, đường màu đỏ là giá trị alpha, đường màu xanh là điểm số mô hình trên tập kiểm tra. Ta tìm được bậc nhỏ nhất (cực tiểu toàn cục) là 2
		\begin{figure}[H]
			\centering
